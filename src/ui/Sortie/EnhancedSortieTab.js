...
const headCells = [
  ...
  { id: "dateDepointage", label: "DATE HEURE DE SORTIE" },
];
...
const EnhancedTableToolbar = (props) => {
  ...
  const onShowEdit = () => {
    ...
    props.editSortie(props.selected);
    props.setDialogOpenEdit(true);
    props.setDateDepointageHelper("");
    // props.setSelected([]);
  };
      ...
      <Snackbar
        ...
        onClose={(event, reason) => {
          if (reason === "clickaway") {
            ...
            ids.map((id) => props.deleteSortieById(id));
...
export default function EnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = React.useState("dateDepointage");
    ...
    <div className={classes.root}>
      <Paper className={classes.paper} elevation={0}>
        <EnhancedTableToolbar
          ...
          deleteSortieById={props.deleteSortieById}
          selected={selected}
          setSelected={setSelected}
          setDialogOpenEdit={props.setDialogOpenEdit}
          numSelected={selected.length}
          editSortie={props.editSortie}
          setDateDepointageHelper={props.setDateDepointageHelper}
        />
        <TableContainer>
          <Table
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.dateDepointage}</TableCell>
                    </TableRow>
                  );
                })}
            </TableBody>
