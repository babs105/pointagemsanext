...
const headCells = [
  ...
  { id: "serviceName", label: "SERVICE OU DEPARTEMENT" },
];
...
const EnhancedTableToolbar = (props) => {
  ...
  const onShowEdit = () => {
    ...
    props.editAgent(props.selected);
    props.setDialogOpenEdit(true);
    props.setServiceNameHelper("");
    props.setNomAgentHelper("");
    // props.setSelected([]);
  };
      ...
      <Snackbar
        ...
        onClose={(event, reason) => {
          if (reason === "clickaway") {
            ...
            ids.map((id) => props.deleteAgentById(id));
...
export default function EnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = React.useState("nomAgent");
    ...
    <div className={classes.root}>
      <Paper className={classes.paper} elevation={0}>
        <EnhancedTableToolbar
          ...
          deleteAgentById={props.deleteAgentById}
          selected={selected}
          setSelected={setSelected}
          setDialogOpenEdit={props.setDialogOpenEdit}
          numSelected={selected.length}
          editAgent={props.editAgent}
          setNomAgentHelper={props.setNomAgentHelper}
          setServiceNameHelper={props.setServiceNameHelper}
        />
        <TableContainer>
          <Table
