...
const EnhancedTableToolbar = (props) => {
  ...
  const onShowEdit = () => {
    ...
    props.editUser(props.selected);
    props.setDialogOpenEdit(true);
    props.setUsernameHelper("");
    props.setFirstNameHelper("");
    props.setLastNameHelper("");
    // props.setSelected([]);
  };
      ...
      <Snackbar
        ...
        onClose={(event, reason) => {
          if (reason === "clickaway") {
            ...
            ids.map((id) => props.deleteUserById(id));
    ...
    <div className={classes.root}>
      <Paper className={classes.paper} elevation={0}>
        <EnhancedTableToolbar
          ...
          deleteUserById={props.deleteUserById}
          selected={selected}
          setSelected={setSelected}
          setDialogOpenEdit={props.setDialogOpenEdit}
          numSelected={selected.length}
          editUser={props.editUser}
          setUsernameHelper={props.setUsernameHelper}
          setFirstNameHelper={props.setFirstNameHelper}
          setLastNameHelper={props.setLastNameHelper}
        />
        <TableContainer>
          <Table
